...
<div class="container p-2">
  ...
  <div class="nav-scroller border-bottom border-dark py-1 mb-2" style="border-top-style: ;">
   ...
   <div class="p-md-3 mb-2 text-white rounded bg-dark">
     ...
     <h1 class="display-4 fst-italic" style="font-size: 55px;">Profil</h1>
    </div>
  </div>
  <div class="p-md-3 w-50 mx-auto mb-2">
   <div class="rounded-6 shadow">
      <div class="p-5 ms-5 me-5">
        ...
        <a type="button" href="{{ route('logout') }}" class="btn btn-lg btn-danger mt-5 w-100">Keluar</a>
      </div>
    </div>
 </div>
</div>
